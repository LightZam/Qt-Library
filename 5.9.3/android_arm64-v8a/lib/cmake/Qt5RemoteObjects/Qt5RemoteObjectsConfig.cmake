...
set(Qt5RemoteObjects_VERSION_STRING 5.9.3)
...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    set(Qt5RemoteObjects_PRIVATE_INCLUDE_DIRS
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.9.3"
        "${_qt5RemoteObjects_install_prefix}/include/QtRemoteObjects/5.9.3/QtRemoteObjects"
    )
    ...
    foreach(_module_dep ${_Qt5RemoteObjects_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.3 ${_Qt5RemoteObjects_FIND_VERSION_EXACT}
