...
macro(_populate_Enginio_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Enginio PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Enginio.so"
...
if (NOT TARGET Qt5::Enginio)
    ...
    set(Qt5Enginio_PRIVATE_INCLUDE_DIRS
        "${_qt5Enginio_install_prefix}/include/Enginio/1.2.1"
        "${_qt5Enginio_install_prefix}/include/Enginio/1.2.1/Enginio"
    )
    ...
    _populate_Enginio_target_properties(RELEASE "libQt5Enginio.so" "" )
