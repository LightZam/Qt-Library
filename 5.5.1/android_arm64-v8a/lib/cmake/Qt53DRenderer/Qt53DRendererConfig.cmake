...
macro(_populate_3DRenderer_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DRenderer PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DRenderer.so"
...
if (NOT TARGET Qt5::3DRenderer)
    ...
    set(Qt53DRenderer_PRIVATE_INCLUDE_DIRS
        "${_qt53DRenderer_install_prefix}/include/Qt3DRenderer/5.5.1"
        "${_qt53DRenderer_install_prefix}/include/Qt3DRenderer/5.5.1/Qt3DRenderer"
    )
    ...
    _populate_3DRenderer_target_properties(RELEASE "libQt53DRenderer.so" "" )
