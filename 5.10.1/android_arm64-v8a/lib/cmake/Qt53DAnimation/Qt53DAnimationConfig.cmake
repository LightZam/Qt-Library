...
set(Qt53DAnimation_VERSION_STRING 5.10.1)
...
macro(_populate_3DAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DAnimation PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DAnimation.so"
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.10.1"
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.10.1/Qt3DAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.10.1 ${_Qt53DAnimation_FIND_VERSION_EXACT}
    ...
    _populate_3DAnimation_target_properties(RELEASE "libQt53DAnimation.so" "" )
