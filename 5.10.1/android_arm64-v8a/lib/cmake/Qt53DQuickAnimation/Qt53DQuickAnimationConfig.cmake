...
set(Qt53DQuickAnimation_VERSION_STRING 5.10.1)
...
macro(_populate_3DQuickAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DQuickAnimation PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DQuickAnimation.so"
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.10.1"
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.10.1/Qt3DQuickAnimation"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickAnimation_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.10.1 ${_Qt53DQuickAnimation_FIND_VERSION_EXACT}
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "libQt53DQuickAnimation.so" "" )
